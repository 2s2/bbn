...
$(window).resize( function(){
 if($(document).width() <= 1199) {
  $('.facebook-socialfeed .fb-like-box').removeAttr('data-height');
 }
});
...
$(document).ready(function(){
      ...
      $('#block_top_menu ul > li').has('ul').children('a').append('<i class="fa fa-angle-down"></i>');
      $('#homepage-slider .homeslider-description').addClass('container');
...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').each(function(index, element) {
			html = '';
			html = '<div class="product-container maxheight"><div class="row">';
	...
	else 
	{
		...
		$('.product_list > li').each(function(index, element) {
		html = '';
		html += '<div class="product-container maxheight">';
			...
			html += '<div class="right-block">';
				...
				var price = $(element).find('.content_price').html(); // check : catalog mode is enabled
				if (price != null) { 
				html += '<div itemprop="offers" itemscope itemtype="http://schema.org/Offer"  class="content_price">'+ price + '</div>';
...
$(document).ready(function(){
	...
	if(stickMenu && docWidth > 780) {
		$('body').find('.row-top').wrapInner('<div class="stickUpTop"><div class="stickUpHolder container">');
...
$(window).scroll(function() {
	...
	$('#tmhtmlcontent_home li ').each(function(){
        var imagePos = $(this).offset().top; 
        var topOfWindow = $(window).scrollTop();
            if (imagePos < topOfWindow+500) {
                $(this).addClass("animated  fadeInLeft ");
	 ...
	 $('#homepage-blog ul li:first-child ').each(function(){
        var imagePos = $(this).offset().top; 
        var topOfWindow = $(window).scrollTop();
            if (imagePos < topOfWindow+500) {
                $(this).addClass("animated fadeInLeft ");
	 ...
	 $('#homepage-blog ul li:last-child ').each(function(){
        var imagePos = $(this).offset().top; 
        var topOfWindow = $(window).scrollTop();
            if (imagePos < topOfWindow+500) {
                $(this).addClass("animated fadeInRight ");
