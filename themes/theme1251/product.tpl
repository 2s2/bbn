        ...
        {/if}
                ...
                <div class="pb-right-column {if $columns == 2}col-xs-12 col-md-5 col-lg-6{elseif $columns == 3}col-xs-12 {elseif $content_only} col-xs-6{else}col-sm-6 col-md-6 col-lg-6{/if}">
                    <div class="product-info-line">
                        ...
                        {if isset($HOOK_EXTRA_RIGHT) && $HOOK_EXTRA_RIGHT}<div class="product_comments_block_extra clearfix">{$HOOK_EXTRA_RIGHT}</div>{/if}
                    ...
                    {if !$content_only}
                        ...
                        <ul id="usefull_link_block" class="clearfix no-print">
                            ...
                            <li class="box-cart-bottom">
                                {if isset($HOOK_PRODUCT_ACTIONS) && $HOOK_PRODUCT_ACTIONS}{$HOOK_PRODUCT_ACTIONS}{/if}
                            </li> <!-- end box-cart-bottom -->
                                <!--li class="print">
                                        ...
                                        <div class="product_desc">
                                            ...
                                            <div class="block_description">
                                                <a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{l s='More'}" class="product_description">
                                                    {$accessory.description_short|strip_tags|truncate:2500:'...'}
                                                </a>
                                            </div>
                                        </div>
                                        <div class="s_title_block">
                                            <h5 class="product-name">
                                                <a title="{$accessory.name|escape:'html':'UTF-8'}" href="{$accessoryLink|escape:'html':'UTF-8'}">
                                                    {$accessory.name|truncate:2000:'...':true|escape:'html':'UTF-8'}
                                                </a>
                                            </h5>
                                            {if ((isset($accessory.on_sale) && $accessory.on_sale) || (isset($accessory.reduction) && $accessory.reduction)) && $accessory.price_without_reduction > $accessory.price && $accessory.show_price AND !isset($restricted_country_mode) && !$PS_CATALOG_MODE}
                                                <p class="price_container"><span class="old_price_home">
                                                  {convertPrice price=$accessory.price_without_reduction}
                                                </span></p>{else}<div style="height:21px;"></div>
                                            {/if}
